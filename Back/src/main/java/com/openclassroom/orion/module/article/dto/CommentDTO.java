...
public class CommentDTO {
    ...
    @Schema(description = "L'ID unique du commentaire", example = "10", required = true)
    private Long id;
    ...
    @Schema(description = "L'ID de l'utilisateur qui a posté le commentaire", example = "5", required = true)
    private Long userId;
}
